...
const EmMasterCsvSchema = new mongoose.Schema({
...
const UploadMasterEmCheckFile = mongoose.model("EmailCheckMasterCsvFile", EmMasterCsvSchema);

module.exports = UploadMasterEmCheckFile;