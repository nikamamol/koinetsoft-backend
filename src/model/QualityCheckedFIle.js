...
const QualityCsvSchema = new mongoose.Schema({
...
const QualityCheckedSChema = mongoose.model("QualityCheckedCsvFile", QualityCsvSchema);

module.exports = QualityCheckedSChema;